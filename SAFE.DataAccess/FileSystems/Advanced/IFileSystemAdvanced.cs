...
//namespace ExampleFileSystem
//{
//    /// <summary>
//    /// Interface of a FileSystem.
//    /// </summary>
//    public interface IFileSystemAdvanced : IDisposable
//    {
//        // ----------------------------------------------
//        // Directory API
//        // ----------------------------------------------
...
//        /// <summary>
//        /// Converts the specified path to the underlying path used by this <see cref="IFileSystem"/>. In case of a <see cref="SAFE.FileSystem.PhysicalFileSystem"/>, it 
